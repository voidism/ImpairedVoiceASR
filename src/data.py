...
def create_dataset(tokenizer, ascending, name, path, bucketing, batch_size,
    ...
    elif name.lower() == "hyspeech":
        from corpus.hyspeech import HyDataset as Dataset
    elif name.lower() == "dspspeech":
        from corpus.dspspeech import DspDataset as Dataset
    elif name.lower() == "bznsyp":
        from corpus.bznsyp import BznsypDataset as Dataset
    elif name.lower() == "aishell":
        from corpus.aishell import BznsypDataset as Dataset
    elif name.lower() == "commonvoice":
        from corpus.commonvoice import BznsypDataset as Dataset
    elif name.lower() == "dysar":
        from corpus.dysar import BznsypDataset as Dataset
    elif name.lower() == "ljspeech":
        from corpus.ljspeech import LJDataset as Dataset
    else:
...
def create_textset(tokenizer, train_split, dev_split, name, path, bucketing, batch_size):
    ...
    if name.lower() == "librispeech":
        ...
        from corpus.hyspeech import HyTextDataset as Dataset
    elif name.lower() == "dspspeech":
        from corpus.dspspeech import DspTextDataset as Dataset
    elif name.lower() == "bznsyp":
        from corpus.bznsyp import BznsypTextDataset as Dataset
    elif name.lower() == "aishell":
        from corpus.aishell import BznsypTextDataset as Dataset
    elif name.lower() == "commonvoice":
        from corpus.commonvoice import BznsypTextDataset as Dataset
    elif name.lower() == "dysar":
        from corpus.dysar import BznsypTextDataset as Dataset
    elif name.lower() == "ljspeech":
        from corpus.ljspeech import LJTextDataset as Dataset
    else:
        raise NotImplementedError
...
def load_dataset(n_jobs, use_gpu, pin_memory, ascending, corpus, audio, text):
    ...
    collect_dv = partial(collect_audio_batch,
                         audio_transform=audio_transform_dv, mode='test')
